...
import 'package:bold_freelance/widgets/custom_outlined_button.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Salaries", style: CustomTextStyles.titleMediumBold_1),
                Padding(
          ...
          Padding(
            ...
            child: Text("Jobs", style: CustomTextStyles.titleMediumBold_1),
          ),
          Padding(
            padding: getPadding(top: 16),
            child: Wrap(
